...
class QREnv:
    ...
    BOT_NAME = 'Prime CIC'             # Name of the bot. Will be used in email notifications
    ...
    URL_PROD = "http://10.20.101.48/api/v1"                                               # Use for client production
    ...
    QUEUE_NAMES = []
    STORAGE_NAMES = []
    VAULT_NAMES = ['prime_credentials', 'smtp', 'imap', 'ftp_credentials', 'cic', 'flag']
